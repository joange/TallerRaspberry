...
## Instal·lar client `nfs` i montar carpeta - (en `node_1_x, x=2,3,4`) 

- `sudo mkdir /home/pi/cloud`
- `sudo /etc/fstab` i afegir la linia: 
```
node_1_1:/home/pi/cloud /home/pi/cloud  nfs auto,noatime,nolock,bg,nfsvers=4,intr,actimeo=1800 0 0`
```
