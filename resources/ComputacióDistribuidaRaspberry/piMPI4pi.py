...
# Formula de Leibniz https://en.wikipedia.org/wiki/Leibniz_formula_for_π
...
if rank == 0: 
    ...
    while process < size and slice < total_slices: 
        ...
        print "Sending slice",slice,"to process",process slice += 1 process += 1   
...
if rank == 0: 
    ...
    print ("pi is approximately %.10f, " "error is %.10f" % (pi4,error)) 
